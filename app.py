...
def run_predictive_maintenance_model(key: str) -> plt.Figure:
    ...
    This corrected version robustly captures the matplotlib figure generated by SHAP.
    """
    # [This section remains the same: Data Generation & Model Training]
    np.random.seed(42)
    data = []
    for i in range(10):
        will_fail = i >= 7
    ...
    # Generate the plot on matplotlib's global state but don't show it immediately.
